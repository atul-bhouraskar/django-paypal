...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PayPalPDT.identity_token'
        db.add_column('paypal_pdt', 'identity_token',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PayPalPDT.identity_token'
        db.delete_column('paypal_pdt', 'identity_token')
    ...
    models = {
        u'pdt.paypalpdt': {
            ...
            'identity_token': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
